...
<?php 
    ...
    $perRow=$page*$rowsperpage-$rowsperpage; // phân trang
     $sqlsp="select * from sanpham inner join dmsanpham on sanpham.id_dm=dmsanpham.id_dm order by id_sp DESC limit $perRow,$rowsperpage"; // sap xep theo tang dan
    $query=mysqli_query($conn,$sqlsp);
    $totalrows=mysqli_num_rows(mysqli_query($conn,"select * from sanpham"));// dem so luong
                            ...
                            <table data-toggle="table" data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-sort-name="name" data-sort-order="desc">
                                ...
                                ?>
                                    <tr style="height: 300px;">
                                        ...
                                        <td data-checkbox="true"><a href="quantri.php?page_layout=suasp&idsp=<?php echo $row['id_sp']; ?>"><?php echo $row['ten_sp'] ?></a></td>
                                        ...
                                        <td>
                                            <a href="quantri.php?page_layout=suasp&idsp=<?php echo $row['id_sp']; ?>"><span><svg class="glyph stroked brush" style="width: 20px;height: 20px;"><use xlink:href="#stroked-brush"/></svg></span></a>
                                        </td>

                                        <td>
                                            <a onclick="return xoasanpham();" href="xoasp.php?id=<?php echo $row['id_dm']; ?>"><span><svg class="glyph stroked cancel" style="width: 20px;height: 20px;"><use xlink:href="#stroked-cancel"/></svg></span></a>
                                        </td>
                                    </tr>
                                      <?php }
                                      ?>
