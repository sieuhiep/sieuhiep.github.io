                                    ...
                                    <tr>
                                            ...
                                            <td>
                                                <div class="form-group">
                                                    <input name="variant[{{ $item->id }}]" class="form-control" placeholder="Giá cho biến thể" value="">
                                                </div>
                                            </td>
                                            <td>
                                            <a onclick="return del_variant()" id="" class="btn btn-warning" href="admin/product/delete-variant/{{ $item->id }}" role="button">Xoá</a>
